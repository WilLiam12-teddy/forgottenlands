...
mail.inboxformspec =    "size[8,9;]"..
			...
			"button[5.25,1;2.5,0.5;new;New Message]"..
			"button[5.25,2;2.5,0.5;read;Read]"..
			"button[5.25,3;2.5,0.5;reply;Reply]"..
			"button[5.25,4;2.5,0.5;forward;Forward]"..
			"button[5.25,5;2.5,0.5;delete;Delete]"..
			"button[5.25,6;2.5,0.5;markread;Mark Read]"..
			"button[5.25,7;2.5,0.5;markunread;Mark Unread]"..
			"button[5.25,8;2.5,0.5;about;About]"..
			"textlist[0,0.5;5,8.5;message;"	
