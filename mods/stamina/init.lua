...
STAMINA_HEALTH_TICK = 5		-- time in seconds after player gets healed/damaged
...
STAMINA_EXHAUST_DIG = 1.50		-- exhaustion increased this value after digged node
STAMINA_EXHAUST_PLACE = 0.8	-- .. after digging node
STAMINA_EXHAUST_MOVE = 0.9	-- .. if player movement detected
STAMINA_EXHAUST_JUMP = 3	-- .. if jumping
STAMINA_EXHAUST_CRAFT = 1	-- .. if player crafts
STAMINA_EXHAUST_PUNCH = 32	-- .. if player punches another player
STAMINA_EXHAUST_LVL = 110	-- at what exhaustion player saturation gets lowered
